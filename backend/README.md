...
## Project Structure
    ...
    ├── testapiautoconnecto_63277  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_63277`
...
2. Clone this repo and `cd testapiautoconnecto_63277`
